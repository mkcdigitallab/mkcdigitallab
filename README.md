...
*J'apprends en construisant. Je progresse en comprenant. Je construis pour évoluer.*
...
[![GitLab](https://img.shields.io/badge/GitLab-mkcdigitallab-FC6D26?style=for-the-badge&logo=gitlab)](https://gitlab.com/mkcdigitallab)
...
`MVC` • `POO` • `REST API` • `PDO` • `Eloquent ORM` • `Migrations` • `CI/CD` • `Tests` • `Clean Code`
...
| 🐳 Docker | conteneurs, services, réseaux, environnements reproductibles |
| 🔀 Git / GitHub | branches, commits, remotes, PR, gestion de versions |
...
## 🚧 Projet fil rouge — Reservation-Salles
...
| Projet | Ce que j'y travaille |
|---|---|
| 🍔 [fastfood-mvc](https://github.com/mkcdigitallab/fastfood-mvc) | PHP et architecture MVC |
| 🚗 [vtc-mvc-php](https://github.com/mkcdigitallab/vtc-mvc-php) | Application PHP et organisation MVC |
| 🎓 [gestionNotePOO](https://github.com/mkcdigitallab/gestionNotePOO) | Programmation orientée objet |
| 📦 [StoreManager-Pro](https://github.com/mkcdigitallab/StoreManager-Pro) | Gestion et logique métier |
| 📚 [BibliothequeUniversitaire](https://github.com/mkcdigitallab/BibliothequeUniversitaire) | Gestion d'une bibliothèque |
| 🛠️ [Gestion-Ateliers](https://github.com/mkcdigitallab/Gestion-Ateliers) | Gestion d'ateliers |
...
🚀 Construire des **produits technologiques utiles**, capables de répondre à de vrais besoins.
